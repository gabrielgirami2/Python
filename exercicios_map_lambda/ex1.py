...
# ITEM F
verifica_par_impar = lambda x : 1 if (x % 2 == 0) else 0
...
# ITEM H
verifica_maioridade = lambda idade : print(f" A pessoa é maior de idade") if (idade >=18) else print(f"A pessoa é menor de idade")
